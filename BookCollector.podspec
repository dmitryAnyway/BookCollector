...
Pod::Spec.new do |s|
  s.name             = 'BookCollector'
  s.version          = '0.1.0'
  s.summary          = 'Collect all books from the device'
  s.description      = 'This library collect all books from the device and export it to the user with the nice api'

  s.homepage         = 'https://github.com/ext.dzubarev/BookCollector'
